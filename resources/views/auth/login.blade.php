    ...
    <script>
        ...
        $(document).on('click', '#submitLogin', function() {
            ...
            if (email && password) {
                ...
                axios.post(`http://larastartupst.test/api/signin`, {
                    email,
                    password
                }, {
                    headers: {
        ...
        const responseLogin = (data) => {
            ...
            if (data.status == 'success') {
                ...
                // toastInfo(`Your token => ${data.response_data[0].token}`);
            } else {
